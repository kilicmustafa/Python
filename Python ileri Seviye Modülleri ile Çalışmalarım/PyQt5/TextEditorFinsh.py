import sys
import os
from PyQt5.QtWidgets import QFileDialog ,QWidget ,QAction ,QApplication ,qApp ,QMenuBar ,QMenu,QMainWindow ,QTextEdit ,QLabel ,QHBoxLayout ,QVBoxLayout ,QPushButton ,QLayout
